...
def test_create_empty_state():
    ...
    assert jnp.all(state.city_has_windmill == False)
    assert jnp.all(state.city_has_forge == False)
    assert jnp.all(state.city_has_sawmill == False)
    assert jnp.all(state.city_has_market == False)
    assert jnp.all(state.city_has_temple == False)
    assert jnp.all(state.city_temple_level == 0)
    assert jnp.all(state.city_has_monument == False)
    assert jnp.all(state.city_has_wall == False)
    assert jnp.all(state.city_has_park == False)
